...
live2d_settings['canTurnToAboutPage']   = fales;         // 显示 跳转关于页  按钮，可选 true(真), false(假)
...
live2d_settings['aboutPageUrl']         = 'http://scatx.club';   // 关于页地址, '{URL 网址}'
live2d_settings['screenshotCaptureName']= '和scat看板娘のphoto.png'; // 看板娘截图文件名，例如 'live2d.png'
